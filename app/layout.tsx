  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <meta name="keyword" content="ultraquad company,ultraquad consultancy,IT consulting companies in kenya, Cybersecurity solutions,AI Consulting,Fullstack Services" />
